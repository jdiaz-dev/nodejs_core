...
class Worker extends EventEmitter {
  ...
  getHeapSnapshot(options) {
    ...
    console.log('----------js kHandle', kHandle)
    console.log('----------js this[kHandle]', this[kHandle])
    console.log('----------js options', options)
    console.log('----------js optionsArray', optionsArray)
    console.log('----------js heapSnapshotTaker', heapSnapshotTaker)
